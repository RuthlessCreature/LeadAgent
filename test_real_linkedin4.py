...
if 'login' in driver.current_url:
    ...
    print('I will check again in 30 seconds...')
    
    # Wait for login - check every 5 seconds for up to 60 seconds
    for i in range(12):
        time.sleep(5)
        driver.get('https://www.linkedin.com/feed/')
        time.sleep(2)
        ...
        print('Still not logged in after 60 seconds. Please login manually.')
        driver.quit()
        exit()
