...
# 测试 Selenium 点击搜索
queries = [
    {'platform': 'google', 'query': 'Hajj supplies distributor Dubai', 'type': 'company'},
    {'platform': 'instagram', 'query': 'Islamic products seller UAE', 'type': 'people'},
]
